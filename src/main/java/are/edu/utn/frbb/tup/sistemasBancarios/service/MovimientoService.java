...
public interface MovimientoService {
    ...
    public void retiro(long numeroCuenta, double monto) throws CantidadNegativaException, NoAlcanzaException, CuentaNoEncontradaException, ClienteNoExistsException;
    public void depositar(long numeroCuenta, double monto) throws CantidadNegativaException, CuentaNoEncontradaException, ClienteNoExistsException;
